...
int main(int argc, char *argv[])
{
	...
	else if (strchr(argv[a], '/') != NULL)
	{
		...
		autotest = true;
	else if (strcmp(argv[a], "rendertest")==0)
		testallwithrendering = true;
     }
	...
	printf("testallwithrendering = %d\n", testallwithrendering);

     if (!utest && !ueval && !ufilebgen && !ufilegen && !autotest && !testallwithrendering)
	 {
